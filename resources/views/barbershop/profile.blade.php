        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="contact__content">
                    <div class="contact__address">
                        <h5>Profile Barbershop</h5>
                        <ul>
                            <li>
                                <h6><i class="fa fa-map-marker"></i>Nama Barbershop</h6>
                                <p>{{auth()->user()->barbershop->nama}}</p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p>{{auth()->user()->barbershop->nomortelepon}}</p>
                            </li>
                            <li>
                                <h6><i class="fa fa-map-marker"></i>Alamat</h6>
                                <p>{{auth()->user()->barbershop->alamat}}</p>
                            </li>
                        </ul>
                    </div>
                    <a href="/barbershop/{{auth()->user()->id}}/edit">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="contact__map">
                    <img class="img-responsive" src="{{asset('foto/'.auth()->user()->barbershop->foto)}}" alt="Photo">
                </div>
            </div>
        </div>
    </div>
